...
/* 변수에 값 대입 */
// 선언된 변수에 값을 대입하는 것
// 작성법 : 변수명 = 값;  //대입 연산자(=)  A = B; -> B라는 값을 A변수에 대입
                                        //(오른쪽 값을 왼쪽 변수에 대입)
                          // 같다를 뜻하는 연산자 ( == , 비교 연산자)
...
let undef; // 변수 선언
console.log("undif : ", undef, typeof undef);
...
console.log("numbers : ", numbers, typeof numbers);   // numbers :  (3) [10, 20, 30] object

console.log("numbers 배결 값 중 0번째 : " , numbers[0], typeof numbers[0]);
console.log("numbers 배결 값 중 0번째 : " , numbers[1], typeof numbers[1]);
console.log("numbers 배결 값 중 0번째 : " , numbers[2], typeof numbers[2]);
