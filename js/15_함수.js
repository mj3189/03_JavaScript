...
document.querySelector("#btn2a").addEventListener("click", function(){
    ...
    /* 참조란? 
        - 객체 지향 언어에서 배열, 객체 등 object는 값을 여러 개를 가지고 있는
          자료형인데, 변수는 값을 1개만 저장할 수 있기 때문에

          object를 메모리 다른곳에 저장하고 저장된 곳에 주소를 변수에 저장해서
          필요할 때 마다 해당 주소를 찾아가 원하는 값을 얻어오거나 
          수정할 수 있게 하는 것
    ...
    */
    ...
    // arr2에 저장된 주소만 보내서 함수를 수행했기 때문에
    // arr2가 참조하고 있던 배열의 
    // 2번 인덱스 내용이 "딸기"로 변하게 된다
